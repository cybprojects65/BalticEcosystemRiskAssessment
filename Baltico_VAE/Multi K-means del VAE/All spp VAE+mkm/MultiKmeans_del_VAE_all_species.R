...
variables_risk1_standardized <- read_csv("output_high_risk_VAE_all_spp_2.csv")
...
for (n_centroidi in multi_centroidi){
  ...
  output_file<-paste0("./output/all_centroid_classification_assignment_",n_centroidi,"_", year, "_all_spp.csv")
...
best_clusterisation_file = paste0("./centroid_classification_assignment_",best_clusterisation, "_all_spp", ".csv")

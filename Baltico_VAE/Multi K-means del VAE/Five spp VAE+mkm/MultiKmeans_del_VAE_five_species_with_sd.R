...
variables_risk1_standardized <- read_csv("output_vae_five_spp_highrisk.csv")
...
########################################################################  
  ...
  write.csv(centroidi_annotated, 
            file = paste0("./output_sd/all_centroidi_annotated_", n_centroidi, "_", year, "_five_spp_mkm_vae_sd.csv"), 
            row.names = FALSE)
  ...
  output_file<-paste0("./output_sd/all_centroid_classification_assignment_",n_centroidi,"_", year, "_five_spp_mkm_vae.csv")

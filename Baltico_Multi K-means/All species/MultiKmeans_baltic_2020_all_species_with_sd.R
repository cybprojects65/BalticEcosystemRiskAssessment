...
multi_centroidi<- c(34)                 #seq(from=5, to=50, by=1) #Number of centroids to test and compare
...
########################################################################  
  ...
  output_file<-paste0("./output_sd/all_centroid_classification_assignment_",n_centroidi,"_", year, "_all_spp.csv")
